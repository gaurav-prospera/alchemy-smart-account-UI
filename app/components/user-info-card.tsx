...
export default function UserInfo() {
  ...
  // For embedded wallets, use client?.account?.address
  const walletAddress = address || client?.account?.address;
        ...
        <div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="h-6 w-6"
              onClick={() => {
                if (walletAddress && client?.chain?.blockExplorers?.default?.url) {
                  window.open(
                    `${client.chain.blockExplorers.default.url}/address/${walletAddress}`,
                    "_blank"
                  );
                }
              }}
